# Wordpress for Azure App Services (Linux)
...
- Current WordPress version: 6.1 [(official zip)](https://wordpress.org/latest.zip)
- PHP 8.0 version is being used for WordPress on the Azure Marketplace.
